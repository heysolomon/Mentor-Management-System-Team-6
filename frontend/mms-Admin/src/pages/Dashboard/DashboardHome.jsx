    ...
    <div className="w-full h-full">
      <div className="w-full">
        ...
        <div className="flex justify-between">
          ...
          <div className="text-black2 font-[400] text-[16px] py-[4px] px-[8px] bg-pri10 border-[1px] border-pri10 flex items-center hover:cursor-pointer">
            <p>This week</p>
            <ArrowDown />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-5 grid-cols-2 gap-y-[10px] md:gap-y-0 gap-x-[10px] mt-[12px]">
          {/* active programs */}
          <div className="relative h-[46px] md:h-[92px] rounded-[7px] bg-pri3 text-pri11 px-2 flex items-center">
            <button
              type="button"
          ...
          {/* mentors programs */}
          <div className="h-[46px] md:h-[92px] w-full md:py-3">
