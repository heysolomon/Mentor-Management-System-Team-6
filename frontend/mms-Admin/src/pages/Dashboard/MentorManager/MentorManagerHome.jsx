...
import MentorManagerHeader from '../../../components/Dashboard/MentorManager/MentorManagerHeader';
import MentorsLoading from '../../../components/Dashboard/Mentors/MentorsLoading';
import MentorManagerCard from '../../../components/Dashboard/MentorManager/MentorManagerCard';

function MentorManagerHome() {
  ...
  return (
    <div className="h-screen">
      <MentorManagerHeader setGrid={setGrid} grid={grid} />
...
export default MentorManagerHome;
