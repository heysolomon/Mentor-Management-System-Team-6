...
function DropdownCertificateDownload({ options, placeHolder }) {
  ...
  return (
    <div className="relative text-black2 font-[600] text-[16px] py-[4px] px-[8px] border-[1px] border-black9 rounded-[5px] flex items-center hover:cursor-pointer">
      <button
        className="flex"
...
export default DropdownCertificateDownload;
