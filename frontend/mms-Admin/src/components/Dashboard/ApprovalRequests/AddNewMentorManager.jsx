...
import AddMentorManagerSuccess from './AddMentorManagerSuccess';

function AddNewMentorManager() {
  ...
  return (
    <div className="w-full h-full px-10">
      <h2 className="font-[600] text-[24px] text-center">Add Mentor Manager</h2>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-x-[28px] w-[53%] mx-auto h-[50px] mt-[77px]">
          ...
          <button
            ...
            onClick={() => dispatch(openModal(<AddMentorManagerSuccess />))}
          >
            Submit
          </button>
        </div>
...
export default AddNewMentorManager;
