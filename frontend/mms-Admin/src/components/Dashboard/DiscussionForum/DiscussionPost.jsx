...
function DiscussionPost() {
  ...
  return (
    <div className="w-full rounded-[10px] px-[20px] py-[24px] border-[1px] border-black9 mb-[28px]">
      {/* post header */}
      <div className="flex justify-between mb-[15px]">
        ...
        <div className="flex">
          ...
          <div className="ml-[16px]">
            <h3 className="font-[600] text-[20px] text-black2">Alison Davis</h3>
            <p className="text-[12px] font-[400] text-black5">Mentor Manager</p>
          </div>
        </div>
        {/* more options */}
        <button type="button">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex">
          <button type="button" className="mr-1 md:mr-2">
            <CommentIcon />
          </button>
          <button
            type="button"
